...
- 사망 시 제거 방식 정하기
- 플레이어/적 문명 차이가 스탯과 실루엣에서 보이도록 유지
...
- 생산 건물과 랠리 포인트 흐름이 처음 보는 사람에게도 이해되게 만들기

## 10. 승패 규칙
- 승리 조건 1개 정하기
- 패배 조건 1개 정하기
- 적 전멸 또는 적 기지 파괴 시 승리 처리
- 아군 전멸 또는 아군 기지 파괴 시 패배 처리
- 결과 UI 또는 텍스트 표시
- 재시작 방식 정하기
...
- 플레이어/적 문명 차이가 실제 전투에서 느껴지는지 확인
